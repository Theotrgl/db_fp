...
import { AuthDto } from 'dto/auth.dto';
  ...
  export class UserController {
    ...
    @Post('addtransaction')
    transaction(@GetUser() userId: any, @Body('game') game_id: number, @Body('pay_id') payment_method: string) {
    ...
    @Post('review')
    addReview(@GetUser() user : any ,@Body('game') game : number , @Body('rating') rating : number, @Body('comment') comment : string) {
